 ...
 * @Version:        1.0
 */
class RegisterStateViewModel: ViewModel() {
    val account = ObservableField<String>()
    val password = ObservableField<String>()
    val againPassword = ObservableField<String>()
    ...
    fun checkData(): Boolean{
        ...
        if(StringUtils.isEmpty(againPassword.get())){
            ToastUtils.show(appContext.getString(R.string.please_input_again_password))
            return false
        }
        return true
    }

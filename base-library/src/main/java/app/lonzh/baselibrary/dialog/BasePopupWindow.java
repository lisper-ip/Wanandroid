package app.lonzh.baselibrary.dialog;
...
public class BasePopupWindow extends PopupWindow
    ...
    public static class Builder<B extends Builder<?>>{
        ...
        public B setText(@IdRes int viewId, @StringRes int stringId) {
            return setText(viewId, mContext.getString(stringId));
        }
        ...
        public B setHint(@IdRes int viewId, @StringRes int stringId) {
            return setHint(viewId, mContext.getString(stringId));
        }
        public B setHint(@IdRes int id, CharSequence text) {
            ((TextView) (mContentView.findViewById(id))).setHint(text);
            return (B) this;
        }
        ...
        public B setBackground(@IdRes int id, Drawable drawable) {
            mContentView.findViewById(id).setBackground(drawable);
            return (B) this;
        }
        ...
        public B setImageDrawable(@IdRes int id, Drawable drawable) {
            ((ImageView) (mContentView.findViewById(id))).setImageDrawable(drawable);
            return (B) this;
        }
         ...
         * 设置点击事件
         */
        public B setOnClickListener(@IdRes int id, @NonNull OnClickListener<? extends View> listener) {
            if (mClickArray == null) {
        ...
        public BasePopupWindow create() {
            ...
            for (int i = 0; mClickArray != null && i < mClickArray.size(); i++) {
                ...
                if (view != null) {
                    view.setOnClickListener(new ViewClickWrapper(mPopupWindow, mClickArray.valueAt(i)));
                }
            }

 ...
 *    desc   : Dialog 基类
 */
public class BaseDialog extends AppCompatDialog implements LifecycleOwner, HandlerAction, AnimAction,
    ...
    public void dismiss() {
        ...
        if (focusView != null) {
            Objects.requireNonNull(ContextCompat.getSystemService(getContext(), InputMethodManager.class)).hideSoftInputFromWindow(focusView.getWindowToken(), 0);
        }
        super.dismiss();
    }
    ...
    public static class Builder<B extends Builder> {
        ...
        public BaseDialog create() {
            ...
            if (mContext != null) {
                DialogLifecycle.with((Activity) mContext, mDialog);
            }
